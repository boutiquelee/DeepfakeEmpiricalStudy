...
model.load_weights("../model/XceptionNet1.h5")
is_training=True
top_k_layers=134
...
model_checkpoint_callback = ModelCheckpoint(
    filepath="../model/XceptionNet3.h5",
    save_weights_only=True,
    monitor='val_acc',
    mode='max',
    save_best_only=True)
csv_logger = CSVLogger("../model/XceptionNet3.csv", append=True, separator=',')
...
model.save_weights("../model/XceptionNet3_50.h5")
