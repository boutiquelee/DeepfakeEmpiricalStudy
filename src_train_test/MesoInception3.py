...
model.load("../model/MesoInception1.h5")
model=model.model
is_training=True
top_k_layers=32
...
model_checkpoint_callback = ModelCheckpoint(
    filepath="../model/MesoInception3.h5",
    save_weights_only=True,
    monitor='val_acc',
    mode='max',
    save_best_only=True)
csv_logger = CSVLogger("../model/MesoInception3.csv", append=True, separator=',')
...
model.save_weights("../model/MesoInception3_50.h5")
